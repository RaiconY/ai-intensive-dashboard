...
## Календарь — Поток #4 (Апрель 2026)

**Даты потока:** 14 — 30 апреля 2026
**Расписание созвонов:** Вторник + Пятница, 19:00 МСК (последний — четверг)
**Подготовительная неделя:** 7 — 12 апреля 2026

| Созвон | Дата | День | Тема |
|--------|------|------|------|
| 1 | 14 апр | Вторник | Обзор рынка, сравнение AI-инструментов, выбор проекта |
| 2 | 17 апр | Пятница | Рабочие среды, структура проекта, оркестрация моделей |
| 3 | 21 апр | Вторник | Ревью проектов, Git и версионирование, хостинг и деплой |
| 4 | 24 апр | Пятница | Skills, субагенты, хуки, MCP |
| 5 | 28 апр | Вторник | NotebookLM, валидация продукта, маркетинг |
| 6 | 30 апр | **Четверг** | Демо-день, продуктовое мышление |

> **Историческое:** Поток #3 (17 марта — 3 апреля 2026) завершён. Снимок состояния Blobs сохранён в `data/cohort-3-archive.json` (коммит 298564f).
