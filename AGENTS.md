...
> **ВАЖНО:** Любые изменения в этом файле должны также переноситься в `CLAUDE.md` и `GEMINI.md`.
...
## Календарь — Поток #3 (Март—Апрель 2026)

**Даты потока:** 17 марта — 3 апреля 2026
**Расписание созвонов:** Вторник + Пятница, 19:00 МСК

| Созвон | Дата | День | Тема |
|--------|------|------|------|
| 1 | 17 мар | Вторник | Знакомство, цели и проекты, LLM, токены, выбор инструментов |
| 2 | 20 мар | Пятница | Claude Desktop, VS Code, структура проекта, управление контекстом |
| 3 | 24 мар | Вторник | Git и GitHub, первый деплой на Vercel, стек для начинающих |
| 4 | 27 мар | Пятница | MCP, Skills, мультиагентный подход, фидбек проектов |
| 5 | 31 мар | Вторник | NotebookLM, продвижение проектов, подготовка к демо |
| 6 | 3 апр | Пятница | Демо-день |
